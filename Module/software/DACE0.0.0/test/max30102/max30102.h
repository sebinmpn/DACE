...
static const uint8_t intrpt_status_1          =  (0x00);
static const uint8_t intrpt_status_2          =  (0x01);
static const uint8_t intrpt_Enable_1          =  (0x02);
static const uint8_t intrpt_Enable_2          =  (0x03);
static const uint8_t FIFO_w_ptr               =  (0x04);
static const uint8_t OVERFLOW_cnt             =  (0x05);
static const uint8_t FIFO_r_ptr               =  (0x06);
static const uint8_t FIFO_DATA_Reg            =  (0x07);
static const uint8_t FIFO_conf                =  (0x08);
static const uint8_t MODE_conf                =  (0x09);
static const uint8_t SpO2_conf                =  (0x0A);
static const uint8_t LED_pls_Amp1             =  (0x0C);
static const uint8_t LED_pls_Amp2             =  (0x0D);
static const uint8_t MULTI_LED_Mode_REGcp1    =  (0x11);
static const uint8_t MULTI_LED_Mode_REG2      =  (0x12);
static const uint8_t REVISION_ID              =  (0xFE);
static const uint8_t PART_ID                  =  (0xFF);
static const uint8_t MAX_ADDRES               =  (0x57);
static const uint8_t DIE_TEMP_INT             =  (0x1F);
static const uint8_t DIE_TEMP_FRAC            =  (0x20);
static const uint8_t DIE_TEMP_CONFIG          =  (0x21);
static const uint8_t INT_DIE_TEMP_RDY_ENABLE  =  (0x02);
static const uint8_t INT_DIE_TEMP_RDY_DESABLE =  (0x00);
